    ...
    <nav>
      <section className="flex justify-between items-center backg fu">
        ...
        <div className="oj flu">
          ...
          <NavLink to="/" className="rke font-semibold ">
            Home
          </NavLink>
          <NavLink to="/Naga" className="rke font-semibold ">
            Marketplace
          </NavLink>
          <NavLink to="/Scheme" className="rke font-semibold ">
            Dashboard
          </NavLink>
          <NavLink to="#" className="rke font-semibold ">
            Map
        ...
        <button
          className="bars block md:hidden sm:block m-3"
      ...
      <section
        className="hidd relative md:hidden  sm:block"
        style={getMenuStyles(Menuopen)}
        transition={{ duration: 1, delay: 0.4, ease: "easeInOut" }}
      >
        <div className="oj">
          {/* <NavLink to="#" className="rk font-semibold hover:bg-white active:bg-white">About us</NavLink> */}
          <NavLink to="/" className="rk font-semibold active:bg-white">
            Home
          </NavLink>
          <NavLink to="/Marketplace" className="rk font-semibold ">
            Marketplace
          </NavLink>
          <NavLink to="/Scheme" className="rk font-semibold ">
            Dashboard
          </NavLink>
          <NavLink to="/Map" className="rk font-semibold ">
            Map
          </NavLink>
        </div>
