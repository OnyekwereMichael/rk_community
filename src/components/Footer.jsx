    ...
    <div>
      ...
      >
        <p className="text-center font-semibold pt-4">
          Get the Newest Deal and Updates delivered straight to your inbox
        </p>
        ...
        <section className="flex justify-center mt-7 ">
          ...
          <div>
            <button className="inp rounded pl-2 pr-2 p-1  text-white">
              Subscribe
            </button>
          </div>
        </section>

        <section className=" justify-between p-24 gdg flex justify-between">
          <div>
            <ul>
        ...
        <section className="flex justify-center gap-6 font-semibold p-5">
          <div>Term of us</div>
